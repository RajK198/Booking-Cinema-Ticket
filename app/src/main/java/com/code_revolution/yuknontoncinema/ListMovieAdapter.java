...
public class ListMovieAdapter extends ArrayAdapter<ModelList> {
    Context context;
    String[] Version;
    String rating[];
    int image;
    ...
    public ListMovieAdapter(Context context, int layoutResourceId, ArrayList<ModelList> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.genre.setText(model.genre);
